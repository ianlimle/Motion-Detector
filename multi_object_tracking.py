# USAGE
# python multi_object_tracking.py --prototxt mobilenet_ssd/MobileNetSSD_deploy.prototxt \
...
while True:
	...
	# if our list of queues is empty then we know we have yet to create our first object tracker
	...
	# otherwise, we've already performed detection so now we track multiple objects
    else:
